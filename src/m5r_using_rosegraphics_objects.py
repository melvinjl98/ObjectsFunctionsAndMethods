...
#                move by, move center to, clone
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                center point x coordinate, center point y coordinate, radius
#
#     f. What does a RoseWindow RENDER method do?
#            allows for objects attached to a window to be drawn in the window
#
